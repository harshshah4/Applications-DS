...
<table align="center">
<tr>
<td><p align="center"><input type="button" value="Disapprove" 
    onclick="disapprovefunction()" /></p></td>
	
<td><p align="center"><input type="button" value="Approve" 
    onclick="myFunction()" ></p></td></tr>
